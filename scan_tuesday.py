...
candidates = [
    'BHARTIARTL.NS', 'SUNPHARMA.NS', 'ITC.NS', 'TCS.NS', 'INFY.NS',
    'HDFCBANK.NS', 'ICICIBANK.NS', 'RELIANCE.NS', 'TRENT.NS', 'BEL.NS',
    'COALINDIA.NS', 'M%26M.NS', 'DIVISLAB.NS', 'CIPLA.NS', 'BAJFINANCE.NS'
]

print("Scanning candidates for Tuesday 08-Sep-2026...")
results = []
for s in candidates:
    try:
